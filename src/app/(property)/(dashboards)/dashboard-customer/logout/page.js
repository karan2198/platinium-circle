            ...
            <div className="dashboard__content bgc-f7">
              <div className="row ">
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                 ...
                 <div style={{marginTop:'35px',textAlign:'center'}}><h1>Logout</h1></div>
                 <div style={{marginTop:'35px',textAlign:'center'}}><h6>Hi user@email.com,</h6></div>
                 <div style={{marginTop:'35px',textAlign:'center'}}><h6>Are you sure you want to log out from my App ?</h6></div>
                 <div style={{marginTop:'35px',textAlign:'center'}}>
                    <button style={{width:'120px',borderRadius:'10px', marginRight:'20px'}}>No</button>
                    <button style={{width:'120px',borderRadius:'10px'}} onClick={ConfirmLogout}>Yes</button>
                 </div>
                 <div style={{marginTop:'35px',textAlign:'center'}}> <h6>You have been successfully logged out</h6></div>
                </div>
                {/* col-lg-12 */}
              </div>
              {/* End .row */}
