                ...
                <div className="dashboard__content bgc-f7">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <div style={{ marginTop: '30px' }}>
                      <span style={{ fontSize: '22px', marginTop: '20px', color: '#002D62', }}>Old Password :</span>  <span style={{ marginLeft: '50px' ,border:'1px solid black' ,paddingTop:'20px',paddingBottom:'20px',paddingLeft:'10px',paddingRight:'400px',borderRadius:'15px'}}>abcd</span>
                    </div>
                    <div style={{ marginTop: '30px', }}>
                      <span style={{ fontSize: '22px', marginTop: '20px', color: '#002D62', }}>New Password :</span>  <span style={{ marginLeft: '50px' ,border:'1px solid black' ,paddingTop:'20px',paddingBottom:'20px',paddingLeft:'10px',paddingRight:'400px',borderRadius:'15px'}}>abcd</span>
                    </div>
                    <div style={{ marginTop: '30px', }}>
                       <span style={{ marginLeft: '50px' ,border:'1px solid black' ,paddingTop:'20px',paddingBottom:'20px',paddingLeft:'10px',paddingRight:'400px',borderRadius:'15px'}}>Retype New Password</span>
