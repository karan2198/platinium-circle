...
const DashboardHeader = () => {
  ...
  return (
    <>
      ...
      <header  className="header-nav blue-box nav-homepage-style light-header  menu-home4 main-menu  " style={{height:'140px'}}>
        <div style={{ backgroundColor: '#041E42', height: '70px', }} >
          <div className="container-fluid d-flex justify-content-end align-items-center ">
            <div className="h2 d-flex   align-items-end text-light" style={{marginTop:'30px'}}>
              <h5 className="text-light" style={{ marginRight: '20px' , }}>Join/LogIn</h5>
